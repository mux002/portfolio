...
function onStepEnter({ element }) {
    ...
    commitProgress = timeScale(t);                 
    progressEl.value = Math.round(commitProgress);   
    timeEl.textContent = t.toLocaleString('en', { dateStyle:'long', timeStyle:'short' });

    const commitMaxTime = t;
